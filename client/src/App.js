      ...
      <div className="intro">
        <div className="intro-box">
            ...
            <div className="h1-container">
              ...
              <h3 className="full-stack">React || Javascript || Python</h3>
              <h3 className="full-stack">HTML5 || CSS</h3>
              <h3 className="full-stack">Express || Node.JS || SQLite</h3>              
              <h3 className="full-stack">Socket.Io || Heroku || GitHub</h3>                           
            </div>
        </div>
